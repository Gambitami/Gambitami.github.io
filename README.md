...
* [cite_start]**Impacto:** Democratización de la información para el equipo de ventas, reduciendo la dependencia de reportes estáticos[cite: 87, 91].
* [cite_start]**Resultados:** Mejora en la eficiencia operativa y visibilidad clara de los ciclos de vida de productos/servicios[cite: 90, 91].

---

## 🛠️ Stack Tecnológico Profesional
* **Visualización:** Tableau, Power BI (DAX).
* **Ingeniería de Datos:** Python (Pandas, Numpy), SQL (MySQL), Pentaho Spoon.
* **Cloud & Infraestructura:** Amazon Web Services (AWS).
---
